...
export default function AI() {
  ...
  const sendMessage = async (query) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'ai', text: 'Impossible de contacter le backend.' }])
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="page-body">
        ...
        <div className="card fade-in-up">
          <div className="card-header">
            <span className="card-title" style={{ display: 'flex', alignItems: 'center', gap: 8 }}><Bot size={18} /> Conversation</span>
            <span style={{
              fontSize: 12,
              padding: '3px 10px',
            ...
            <div className="chat-messages">
              ...
              {loading && (
                <div className="chat-bubble ai">
                  <div className="chat-avatar ai-avatar"><Bot size={15} /></div>
